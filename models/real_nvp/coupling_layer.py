    ...
    def forward(self, x, sldj=None, reverse=True):
        if self.mask_type == MaskType.CHECKERBOARD:
            ...
            if reverse:
                ...
                # TODO: Should be x = x * exp_s + t
                x = (x + t) * exp_s
                # TODO: IMPORTANT: to understand how checkerboard masking with coupling layer works
                # t = 0 and exp_s = 1 an den Stellen wo das array b die entries 1 hat. 

                # Add sum log-determinant of the Jacobian
                sldj += s.view(s.size(0), -1).sum(-1)
                
        else:
            # Channel-wise mask
            # CHUNK DOCU: https://pytorch.org/docs/stable/torch.html#torch.chunk
