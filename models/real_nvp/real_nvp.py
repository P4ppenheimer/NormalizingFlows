...
class _RealNVP(nn.Module):
    ...
    The following architecture is implemented at each scale:

        if current_scale != last_scale:
            1) Three coupling layers with alternating checkerboard masks
            2) Perform squeeze operation
            3) Three coupling layers with alternating channel-wise masks
        elif current_scale == last_scale:
            1) Four coupling layers with alternating checkerboard masks
